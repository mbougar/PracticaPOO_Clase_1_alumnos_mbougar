...
Implementar el resto de comentarios _TODO de la función main().
...
fun main() {
    ...
    //_TODO: Crear 3 cafeteras en la Sala, Cocina y Oficina
    val cafetera1 = Cafetera("Sala")
    val cafetera2 = Cafetera("Cocina", 750)
    val cafetera3 = Cafetera("Oficina", 500, 200)

    //_TODO: Crear una lista de 20 tazas con capacidades aleatorias
    val listaTazas = ListaTazas()
    val tamaniosTaza = listOf(50, 75, 100)

    repeat(20) {listaTazas.agregarTaza(Taza(
        (Color.values().random().toString()),
        tamaniosTaza[Random.nextInt(0,3)]
    ))}
   
    println("**********************************************")
    //_TODO: Mostrar por pantalla el contenido de las 3 cafeteras y las tazas.
    println("Cafetera 1: $cafetera1")
    println("Cafetera 2: $cafetera2")
    println("Cafetera 3: $cafetera3")

    for (taza in listaTazas.tazas) {
    ...
    //_TODO: Llenar la cafetera1 de café.
    cafetera1.llenar()

    //_TODO: Vaciar la cafetera2.
    cafetera2.vaciar()

    //_TODO: Agregar café a la cafetera2 a la mitad de su capacidad.
    cafetera2.agregarCafe(375)

    //_TODO: Agregar 400 c.c. de café a la cafereta3
    cafetera3.agregarCafe(400)

    println("**********************************************")
    //_TODO: Mostrar por pantalla el contenido de las 3 cafeteras
    println("Cafetera 1: $cafetera1")
    println("Cafetera 2: $cafetera2")
    println("Cafetera 3: $cafetera3")
    ...
    //_TODO: Servir café en las tazas... siempre que haya café en la cafetera y en el orden cafetera1, cafetera2 y cafetera3.
    for (taza in listaTazas.tazas) {
